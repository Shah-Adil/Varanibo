...
import FurnitureAside from "./FurnitureAside";
...
<h2 className='text-center mt-5 fw-semibold' style={{color: "var(--main-color)"}}>Furniture</h2>
      ...
      <div className="search-result mt-4">
          <div className="row">
            <div className="col-md-3">
                <FurnitureAside  filter={filter}  setFilter={setFilter} />
            </div>
            <div className="col-md-9">
              ...
              <div className="hotel-list-body">
                  <FurnitureBox  HotelData={FurnitureData} />
