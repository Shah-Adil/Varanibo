...
const Hotel = () => {
  ...
  return (
    <>
      ...
      <h2 className='text-center mt-5 fw-semibold' style={{color: "var(--main-color)"}}>Hotel Booking</h2>
...
<div className="search-result mt-4">
    <div className="row">
      <div className="col-md-3">
          <HotelAside  filter={filter}  setFilter={setFilter} />
      </div>
