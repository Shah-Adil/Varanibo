            ...
            <div className='hotel-page-top p-4 mt-4 mb-5' id='see-price'>
              ...
              <div className="table-responsive">
                <table className="table table-bordered">
                    <thead className=''>
                      <tr >
                      <th className='ps-3' >Package Type</th>
                      <th className='text-center'>Package Info</th>
                        ...
                        return (
                          ...
                          <td className='ps-3'>
                            <div className='d-flex align-items-center gap-2'>
                              <div>
                                {h.roomImage.slice(0 , 1 ).map((ri , index ) => {
                                  return (
                                    <img src={ri}  key={index} alt="img" style={{width: 50 , height: 50  ,  borderRadius: 5}} />
                                  )
                                })}
